...
return [
    ...
    'upload' => [
        ...
        'imagePathFormat' => '/editor/image/{yyyy}/{mm}/', /* 上传保存路径,可以自定义保存路径和文件名格式 */
        ...
        'scrawlPathFormat' => '/editor/image/{yyyy}/{mm}/', /* 上传保存路径,可以自定义保存路径和文件名格式 */
        ...
        'snapscreenPathFormat' => '/editor/image/{yyyy}/{mm}/', /* 上传保存路径,可以自定义保存路径和文件名格式 */
        ...
        'catcherPathFormat' => '/editor/image/{yyyy}/{mm}/', /* 上传保存路径,可以自定义保存路径和文件名格式 */
